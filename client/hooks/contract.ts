...
export const CONTRACT_ADDRESS =
  "CDF5RLXDSRSJSB2PORTO25A2UA22LS5GV3DDE5W22THP5PPDBMUXHEJ5";
...
// ============================================================
// NFT Royalty System — Contract Methods
// ============================================================

/**
 * Mint an NFT with royalty settings.
 * Calls: mint_nft(nft_id: u32, creator: Address, royalty_percentage: u32)
 */
export async function mintNFT(
  ...
  return callContract(
    "mint_nft",
    [toScValU32(nftId), toScValAddress(creator), toScValU32(royaltyPercentage)],
    caller,
    true
  );
}
 ...
 * Calls: get_nft(nft_id: u32) -> { creator: Address, royalty_percentage: u32 }
 * Returns: { creator: string, royalty_percentage: number } or null
 */
...
/**
 * Calculate royalty for a sale (read-only).
 * Calls: calculate_royalty(nft_id: u32, sale_price: i128) -> i128
 * Returns: royalty amount as bigint
 */
export async function calculateRoyalty(
  ...
  return readContract(
    "calculate_royalty",
    [toScValU32(nftId), toScValI128(salePrice)],
    caller
  );
}
